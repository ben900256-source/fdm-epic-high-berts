...
test('Dragon Prince cavalry loads and identifies the mount',async({page})=>{
  ...
  await page.selectOption('#part','aurelian.dragon-prince-horse@5');await page.click('#fit');
  ...
  expect(found).toBe(true);await page.keyboard.up('Control');await expect(page.locator('#piece-reference')).toHaveText('aurelian.dragon-prince-horse@5');
