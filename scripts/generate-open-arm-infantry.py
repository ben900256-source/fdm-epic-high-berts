"""Publish the fuller opened-arm visual trial, preserving prior revisions."""
import json
import sys
...
(ROOT/'tests/fixtures/open-arm-infantry-golden.json').write_text(json.dumps({p.reference:p.sha256 for p in parts},indent=2)+'\n')
