"""Publish the decorative spearhead trial as immutable component revisions."""
import json
import sys
...
figures = [json.loads((ROOT/f'specs/experiments/uniform-spear-infantry-{i}-trial.json').read_text())
           for i in range(1, 6)]
...
(ROOT/'tests/fixtures/decorative-spear-golden.json').write_text(
