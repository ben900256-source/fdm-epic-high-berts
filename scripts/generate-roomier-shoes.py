"""Save immutable shoe revisions and repin the current infantry assembly."""
import argparse
import json
...
from fdm_sculpt.components.roomier_shoes import revised_parts
...
def generate(seed):
    ...
    for part in parts:
        ...
        replacements[part.to_dict()['parameters']['shoe_fit']['source']] = part
    golden = ROOT/'tests/fixtures/roomier-shoes-v5-golden.json'
